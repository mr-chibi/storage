#
execute as @e[type=minecraft:villager,tag=player_storage,tag=page_5] at @s run function storage:save/page_5
execute as @e[type=villager,tag=player_storage,tag=page_5] at @s run data modify entity @s Tags set value ["player_storage", "page_1"]
